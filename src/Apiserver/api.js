...
// //var of array starting todos
// var makeTodos = [{
//     id: 'ae06181d-92c2-4fed-a29d-fb53a6301eb9',
//     text: 'Plant spring flowers',
//     isCompleted: false,
//     createdAt: new Date(),
// }, {
...
//     setTimeout(() => res.status(200).json(makeTodos), 2000);
// });
...
//     const { id } = req.params;
//     const matchingTodo = makeTodos.find(todo => todo.id === id);
//     const updatedTodo = {
//         ...matchingTodo,
//         isCompleted: true,
//     }
//     if (updatedTodo) {
//         makeTodos = makeTodos.map(todo =>
//             todo.id === id
//                 ? updatedTodo
//                 : todo);
...
//     const { id } = req.params;
//     const removedTodo = makeTodos.find(todo => todo.id === id);
//     makeTodos = makeTodos.filter(todo => todo.id !== id);
